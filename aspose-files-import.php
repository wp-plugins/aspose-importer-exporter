        ...
        <?php
            ...
            <div id="tabs">
                ...
                <div id="tabs-2">
                    ...
                    <br /> <br />
                    <input type="button" class="button-primary insert_content" content_type = "text" style="position:fixed; margin-top:35px; margin-left:350px;" id="insert_aspose_pdf_content" value="Insert HTML to Editor" />
